...
public class EmployeeController {
	...
	@GetMapping("/getName/{city}")
	public ResponseEntity<List<Employee>> getEmployeeByCity(@PathVariable("city") String city ){
		List<Employee> cc= employeeService.getEmployeeCity(city);
		logger.info("Employee Rest Controller Implementation : getEmployeeByCity() method");
